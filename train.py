...
def init_dataset_kwargs(data, dataset_class):
    ...
    class_names = {
        ...
        'hdf5': 'training.dataset.HDF5FolderDataset',
    }
...
@click.option('--r_channel',   help='R channel to use to save image snapshots, only',
              type=int, default=2, show_default=True)
@click.option('--g_channel',   help='G channel to use to save image snapshots',
              type=int, default=1, show_default=True)
@click.option('--b_channel',   help='B channel to use to save image snapshots',
...
def main(**kwargs):
    ...
    c.rgb_channels = (opts.r_channel, opts.g_channel, opts.b_channel)
